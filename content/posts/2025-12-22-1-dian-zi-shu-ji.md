...
まずは次のようなステップで試してみると、無理なく始めやすくなります。

1. いま読んでいる本の中から、「一度読めば十分な本」を1冊だけ電子で買ってみる  
2. 1週間ほど、通勤・就寝前など決まった時間に電子書籍を開いてみる  
3. 読みやすさ・価格・保管のしやすさを紙の本と比べてみる

そのうえで、「どのジャンルを電子にするか」「どの場面では紙が良いか」を少しずつ決めていくと、自分に合った読書環境が自然と整っていきます。

より具体的な読み方の工夫やジャンル別のおすすめは、
でも詳しく解説しています。
