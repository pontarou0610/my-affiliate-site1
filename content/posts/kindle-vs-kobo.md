...
<section class="comparison-choice-cta google-auto-ads-ignore" aria-label="比較後の確認導線">
  <div class="offerbox-head">
    <span class="offerbox-pr">PR</span>
    <p class="cta3-title">比較したら、次は公式ページで条件を確認</p>
  </div>
  <p>端末価格、読み放題対象、ポイント還元は変わるため、この記事で方向性を決めたあとに販売ページで現在の条件を確認してください。</p>
  <div class="comparison-choice-cta__grid">
    <a class="btn brand-amazon" href="https://amzn.to/48wNGzs" target="_blank" rel="nofollow sponsored noopener noreferrer" data-affiliate="amazon" data-affiliate-slot="comparison-decision">Kindle Paperwhiteを見る</a>
    <a class="btn brand-amazon" href="https://amzn.to/4oyRBSx" target="_blank" rel="nofollow sponsored noopener noreferrer" data-affiliate="amazon" data-affiliate-slot="comparison-decision">Kindle Unlimitedを確認</a>
    <a class="btn brand-rakuten" href="https://books.rakuten.co.jp/event/e-book/ereaders/" target="_blank" rel="nofollow sponsored noopener noreferrer" data-affiliate="rakuten" data-affiliate-slot="comparison-decision">Kobo端末を見る</a>
  </div>
</section>
...
<section class="comparison-choice-cta comparison-choice-cta--bottom google-auto-ads-ignore" aria-label="比較後の購入先">
  <div class="offerbox-head">
    <span class="offerbox-pr">PR</span>
    <p class="cta3-title">最後にもう一度、購入先を確認</p>
  </div>
  <p>Amazon中心ならKindle、楽天ポイントやEPUB重視ならKobo。迷う場合は端末価格と読み放題対象を見てから決めるのが安全です。</p>
  <div class="comparison-choice-cta__grid">
    <a class="btn brand-amazon" href="https://amzn.to/48wNGzs" target="_blank" rel="nofollow sponsored noopener noreferrer" data-affiliate="amazon" data-affiliate-slot="comparison-bottom">Paperwhiteの価格を見る</a>
    <a class="btn brand-amazon" href="https://amzn.to/4oyRBSx" target="_blank" rel="nofollow sponsored noopener noreferrer" data-affiliate="amazon" data-affiliate-slot="comparison-bottom">Unlimited対象を確認</a>
    <a class="btn brand-rakuten" href="https://books.rakuten.co.jp/e-book/" target="_blank" rel="nofollow sponsored noopener noreferrer" data-affiliate="rakuten" data-affiliate-slot="comparison-bottom">楽天Koboストアを見る</a>
  </div>
</section>
