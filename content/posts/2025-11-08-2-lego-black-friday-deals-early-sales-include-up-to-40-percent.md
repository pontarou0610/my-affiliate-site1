...
## 要点
- スター・ウォーズ／ディズニーの一部セットが最大40%オフ。
- 公式ストアと主要ECで価格差があるため、送料とポイントも含めて比較。

## 買うときのチェックリスト
1. 欲しいセットの国内在庫と納期を確認。
2. 公式クーポンやポイント還元を適用し、実質価格を計算。
3. プレゼント用途なら到着日と外箱の状態レビューも確認。

## リンク
- レゴ公式ストア: https://www.lego.com/
- Amazonレゴセール: https://www.amazon.co.jp/s?k=LEGO
