---
title: "NotebookLMでEPUBを読み込む方法｜要約・質問・音声化の手順と注意点"
date: 2026-03-26
lastmod: 2026-06-22
draft: false
...
tags: ['NotebookLM', 'EPUB', '生成AI', '電子書籍', '使い方']
categories: ["電子書籍"]
description: "NotebookLMへEPUBを追加し、章の要約、質問、音声概要、レポートへ活用する手順を解説。対応上限、著作権、モバイル版の制限も確認できます。"
slug: "notebooklm-niepub-pptxhuairunosaho-to-ainiyorusuraitoxiu-zhe"
hasRelatedProducts: false
showRakutenWidget: false
---

## NotebookLMにEPUBを読み込む最短手順

デスクトップ版NotebookLMはEPUBをソースとして直接追加できます。Google公式ヘルプでは、アップロードする1ソースにつき最大500,000語または200MB、無料ユーザーはノートブックあたり最大50ソースと案内されています。モバイルアプリは対応する入力形式が限られるため、EPUBの追加はパソコンのブラウザ版で行うのが確実です。

1. パソコンで[NotebookLM](https://notebooklm.google.com/)を開く
2. 新しいノートブックを作成する
3. 「ソースを追加」からEPUBファイルを選ぶ
4. 読み込み後、ソースガイドで全体の要約を確認する
5. チャットで章名や論点を指定して質問する
6. 必要に応じて音声概要、レポート、学習用の質問へ展開する

アップロードできるのは、自作EPUB、権利者から許可を得たファイル、利用条件上アップロードが認められた資料です。購入した電子書籍を含め、権利のないコンテンツやDRMを回避したファイルは使用しないでください。対応形式と上限は[NotebookLM公式ヘルプ](https://support.google.com/notebooklm/answer/16215270?hl=ja)で更新前に確認できます。

## NotebookLMのEPUB対応で何が変わったのか
...
NotebookLMや生成AIを仕事・学習で継続利用する場合は、プロンプト例や著作権、情報管理まで扱う実用書も比較対象になります。無料機能を試して不足を感じた場合だけ確認してください。

{{< affbtn url="https://www.amazon.co.jp/s?k=NotebookLM+%E6%9C%AC" text="NotebookLM・生成AIの実用書を比較" store="amazon" slot="notebooklm-epub-books" >}}
