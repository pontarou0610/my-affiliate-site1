...
再活用ではなく現行機への買い替えも考える場合は、[Kindleの端末・読み放題・資料管理ガイド](/lp/kindle/)で、Paperwhiteと無印Kindleの違い、Kindle Unlimited、Send to Kindleの条件をまとめて確認できます。古い端末で残す役割と、新しい端末へ移す役割を先に分けると判断しやすくなります。
